		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<table class="table table-responsive table-bordered">
					...
					<tbody>
						<?php $__empty_1 = true; $__currentLoopData = $komentars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komentar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
							<?php if($komentar->status == 'wappr'): ?>
							<tr>
								<td>
									...
									<a href="#" onclick="confirm('Komentar yang akan disetujui akan tampil pada website?', '<?php echo e(route("komentar-approve", array('id' => $komentar->id))); ?>')"><i class="fa fa-check"></i> Setujui</a>
								</td>
