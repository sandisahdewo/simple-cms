      ...
      <div class="col-sm-9">
        <center class="title-slide">
          <h2 class="black">Lorem Ipsum</h2>
            <p><h5><i>Lorem Ipsum is simply dummy text of the printing and typesetting industry</i></h5></p>
        </center>
        <div class="info-menu">
          <div class="left-side-title"><?php echo e($page->judul); ?></div>
          <div class="left-side-text">
            <?php echo e(content($page->isi, false)); ?>
