...
<?php echo Form::model($post, ['route' => ['post-update', $post->id], 'class' => 'form-horizontal form-label-left']); ?>
    ...
    <?php echo $__env->make('admin.post.image.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo Form::close(); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        format: "dd-mm-yyyy",
        autoclose: true,
        defaultDate: <?php echo e(ifExists(CarbonDate('d-m-Y', $post->tanggal_posting), CarbonDate('d-m-Y'))); ?>
