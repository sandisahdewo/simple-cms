            ...
            <div id="navbar" class="navbar-collapse collapse pull-right">
              <ul class="nav navbar-nav">
                <?php 
                    ...
                    $parentMenus = App\Model\Admin\DaftarMenu::whereIdMenu($menu->id)->whereParentId(null)->get();
                 ?>
                <?php $__empty_1 = true; $__currentLoopData = $parentMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li><a href="<?php echo e(url("$menu->url")); ?>"><?php echo e($menu->menu); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    
                <?php endif; ?>
<!--                <li><a href="<?php echo e(route('home')); ?>">HOME</a></li>
                <li><a href="<?php echo e(route('pages', ['profil'])); ?>">PROFIL</a></li>
                <li><a href="<?php echo e(route('album')); ?>">ALBUM</a></li>
                <li><a href="<?php echo e(route('berita')); ?>">BERITA</a></li>
                <li><a href="<?php echo e(route('kegiatan')); ?>">KEGIATAN</a></li>
                <li><a href="<?php echo e(route('pengaduan')); ?>">PENGADUAN</a></li>
-->
                <li>
