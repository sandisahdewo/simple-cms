            ...
            <div class="gallery-box">
                <div class="row">
                    <div class="col-sm-5 gallery-box-img">
                        <img src="<?php echo e(isset($galeri->first()->gambar) ? $galeri->first()->gambar : ''); ?>" alt="Empat">
                    </div>
                    <div class="col-sm-7">
                        <div class="gallery-box-text">
                            <h4 class="gallery-box-title"><?php echo e(isset($galeri->first()->judul) ? $galeri->first()->judul : ''); ?></h4>
                            <span class="white"><?php echo e(CarbonHumanDate(null, isset($galeri->first()->tanggal_posting) ? $galeri->first()->tanggal_posting : '')); ?> - <?php echo e(isset($galeri->first()->dibuat_oleh) ? $galeri->first()->dibuat_oleh : ''); ?></span>
                            <p class="justify-style"><?php echo e(content(isset($galeri->first()->isi) ? $galeri->first()->isi : '', false)); ?></p>
                        </div>
                        <div class="gallery-box-album">
                            <?php $__empty_1 = true; $__currentLoopData = $galeri->splice(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galeriImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
