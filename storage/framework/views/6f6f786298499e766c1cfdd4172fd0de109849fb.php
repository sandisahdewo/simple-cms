    ...
    <tbody>
        ...
        <tr>
            <td width="400">
                ...
                |
                <a href="javascript:void(0)" onclick="confirm('Postingan yang dihapus tidak bisa dikembalikan lagi?', '<?php echo route('post-delete', $row->id); ?>')"><i class="fa fa-trash"></i> Delete</a>
                |
