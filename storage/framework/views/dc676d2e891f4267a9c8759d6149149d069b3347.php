    ...
    <div class="row">
      <div class="col-sm-9">
        <center class="title-slide">
          ...
          <!-- <p><h5 class="grey"><i>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</i></h5></p> -->
				...
				<form class="form-group">
						<div class="col-md-2">
								<?php echo e(Form::select('year', $optArsip, request()->segment(2), ['onchange' => 'changeTahunBulan()', 'class' => 'form-control input-sm', 'id' => 'tahun'])); ?>
        ...
        <div class="left-side-activity">
          ...
          <div class="left-side-activity-text">
            <div class="row">
              ...
              <div class="col-sm-8">
								<?php echo content($report->isi, 350, '<a href="'.route('kegiatan-detail', $report->slug).'">Selengkapnya <i class="fa fa-angle-double-right"></i></a>'); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          <p>Tidak ada kegiatan untuk ditampilkan pada bulan ini!</p>
				<?php endif; ?>
      </div>
      <div class="col-sm-3">
...
<?php $__env->startPush('public-script'); ?>
  <script>
    function changeTahunBulan() {
      ...
      $('#btn-filter').attr('href', '<?php echo e(asset('kegiatan')); ?>/'+tahun+'/'+bulan);
    }
