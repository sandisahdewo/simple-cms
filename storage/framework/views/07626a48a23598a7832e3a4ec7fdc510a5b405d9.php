...
<div class="col-md-12">
    <div class="x_panel">
        ...
        <a href="<?php echo e(route('post-create', 'format=page')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Halaman</a> 
        <div class="x_content">
            <div class="well" style="overflow: auto;">
                <form class="form-group">
                    ...
                    <div class="btn-group btn-sm" style="margin-top: -5px">
                        <a href="<?php echo e(route('halaman')); ?>" class="btn btn-sm btn-default">Semua</a>
                        <a href="<?php echo e(route('halaman', 'status=draft'.'&format='.request()->get('format').'&jenis='.request()->get('jenis').'&kategori='.request()->get('kategori').'&tag='.request()->get('tag'))); ?>" class="btn btn-sm btn-default">Draft (<?php echo e($countDraft); ?>)</a>
                        <a href="<?php echo e(route('halaman', 'status=publish'.'&format='.request()->get('format').'&jenis='.request()->get('jenis').'&kategori='.request()->get('kategori').'&tag='.request()->get('tag'))); ?>" class="btn btn-sm btn-default">Publish (<?php echo e($countPublish); ?>)</a>
                    </div>
            </div>
