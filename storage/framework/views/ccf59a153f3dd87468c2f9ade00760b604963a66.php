    ...
    <script src="<?php echo e(asset('assets/pluggins/jQuery/jQuery-2.2.0.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/pluggins/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/pluggins/pgw-slideshow-master/pgwslideshow.min.js')); ?>"></script>
    <script type="text/javascript">
      $(document).ready(function() {
        $('.pgwSlideshow').pgwSlideshow();
      });
    </script>
    <?php echo $__env->yieldPushContent('public-script'); ?>
  </body>
</html>