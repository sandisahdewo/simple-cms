      ...
      <div class="row">
        ...
        <div class="col-sm-3 activity-box">
          ...
          <div class="activity-text">
            ...
            <a href="post.php">Selengkapnya <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
      ...
      <div id="myReport" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
          ...
          <?php $__currentLoopData = $sliderBerita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li data-target="#myReport" data-slide-to="0" class="report-slide <?php if($countsLiBerita=0): ?> active <?php endif; ?>"></li>
            <?php  $countsLiBerita++  ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ol>
        <div class="carousel-inner" role="listbox">
          <?php  $countsBerita = 0  ?>
          <?php $__currentLoopData = $sliderBerita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item item-report active">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="item-report-text">
                      ...
                      <p class="justify-style"><?php echo e($berita->isi); ?></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            <div class="gallery-box-text">
              ...
              <span class="white"><?php echo e(CarbonHumanDate($galeri->first()->tanggal_posting)); ?> - <?php echo e($galeri->first()->dibuat_oleh); ?></span>
              <p class="justify-style"><?php echo e($galeri->first()->isi); ?></p>
            </div>
