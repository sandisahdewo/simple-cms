        ...
        <?php $__currentLoopData = $komentars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:void(0)" onclick="reply(<?php echo e($row->id); ?>)"><i class="fa fa-reply"></i> Balas</a>
                    |
                    <a href="javascript:void(0)" onclick="confirm('Komentar yang dihapus tidak bisa dikembalikan lagi?', '<?php echo route('komentar-destroy', $row->id); ?>')"><i class="fa fa-trash"></i> Hapus</a>
                    |
